...
class OnlineStoreControllerTest {
    ...
    void shouldPayWithCreditCard() {
        ...
        controller.acceptIncomingRequest("Pay Order with Credit Card");

        assertTrue(output.toString()
                .contains("Executing Credit Card Payment"));
    }
    ...
    void shouldPayWithPaypal() {
        ...
        controller.acceptIncomingRequest("Pay Order with Paypal");

        assertTrue(output.toString()
                .contains("Executing Paypal Payment"));
    }
}
